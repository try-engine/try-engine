...
IF(NOT GLFW_LIBRARY OR TRY_FORCE_DOWNLOAD_GLFW)
    ...
    IF(WIN32)
        SET(GLFW_BUILD_C_FLAGS "")
    ELSE(WIN32)
        SET(GLFW_BUILD_C_FLAGS -fPIC)
    ENDIF(WIN32)
    ...
    ExternalProject_Add(project_glfw 
        ...
        CMAKE_ARGS -DCMAKE_C_FLAGS:STRING=${GLFW_BUILD_C_FLAGS} -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DGLFW_BUILD_DOCS:BOOL=OFF -DGLFW_BUILD_EXAMPLES:BOOL=OFF -DGLFW_BUILD_TESTS:BOOL=OFF
        LOG_DOWNLOAD 1
        LOG_UPDATE 1
        LOG_CONFIGURE 1
        LOG_BUILD 1
...
ENDIF(NOT GLFW_LIBRARY OR TRY_FORCE_DOWNLOAD_GLFW)
